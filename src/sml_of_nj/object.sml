signature UNSAFE_OBJECT = sig
  ...
  (*!
   * toTuple ob If ob is a record, tuple, vector, or real-array, get a vector of its fields;
  ...
  (*!
   * toInt32 ob If ob is really a 32-bit integer or byte-vector of length 4, view it as an
   * Int32.int, otherwise raise Representation.
   *)
  ...
  (*!
   * toWord32 ob If ob is really a 32-bit value or byte-vector of length 4, view it as a
   * Word32.word, otherwise raise Representation.
   *)
