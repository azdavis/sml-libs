...
structure AtomMap : ORD_MAP
  where type Key.ord_key = Atom.atom
  = struct end

structure AtomBinaryMap : ORD_MAP
  where type Key.ord_key = Atom.atom
  = struct end

structure AtomRedBlackMap : ORD_MAP
  where type Key.ord_key = Atom.atom
  = struct end
...
structure IntRedBlackMap : ORD_MAP
  where type Key.ord_key = int
  = struct end

structure WordRedBlackMap : ORD_MAP
  where type Key.ord_key = word
  = struct end
